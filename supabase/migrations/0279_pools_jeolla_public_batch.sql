-- Pool's day — 전라도(전북·전남) 공공 수영장 1차 배치 등록 (POOL_0151~0164, 14곳).
--
-- ## 시간표 출처 [1차 — 운영자 공식]
...
insert into public.pools (
  ...
  ('POOL_0151', '전주완산수영장', '전북', '전주시 완산구', '전북특별자치도 전주시 완산구 쑥고개로 366-7',
...
insert into public.pools (
  ...
  ('POOL_0152', '전주덕진수영장', '전북', '전주시 덕진구', '전북특별자치도 전주시 덕진구 백제대로 310',
...
insert into public.pools (
  ...
  ('POOL_0153', '정읍체육트레이닝센터', '전북', '정읍시', '전북특별자치도 정읍시 서부산업도로 138-5',
...
insert into public.pools (
  ...
  ('POOL_0154', '남원실내수영장', '전북', '남원시', '전북특별자치도 남원시 충청로 341',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0154', '풀스데이', $${"월":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:00","hours":4},{"start":"18:00","end":"20:50","hours":2.83}],"화":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:00","hours":4},{"start":"18:00","end":"20:50","hours":2.83}],"수":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:00","hours":4},{"start":"18:00","end":"20:50","hours":2.83}],"목":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:00","hours":4},{"start":"18:00","end":"20:50","hours":2.83}],"금":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:00","hours":4},{"start":"18:00","end":"20:50","hours":2.83}],"토":[{"start":"05:50","end":"11:50","hours":6},{"start":"13:00","end":"17:50","hours":4.83}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0155', '지리산권실내수영장', '전북', '남원시', '전북특별자치도 남원시 인월면 황산로 1804',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0155', '풀스데이', $${"월":[{"start":"09:00","end":"18:00","hours":9}],"화":[{"start":"09:00","end":"18:00","hours":9}],"수":[{"start":"09:00","end":"18:00","hours":9}],"목":[{"start":"09:00","end":"18:00","hours":9}],"금":[{"start":"09:00","end":"18:00","hours":9}],"토":[{"start":"09:00","end":"18:00","hours":9}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0156', '김제실내수영장', '전북', '김제시', '전북특별자치도 김제시 도작로 224-32',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0156', '풀스데이', $${"월":[{"start":"05:30","end":"20:00","hours":14.5}],"화":[{"start":"05:30","end":"20:00","hours":14.5}],"수":[{"start":"05:30","end":"20:00","hours":14.5}],"목":[{"start":"05:30","end":"20:00","hours":14.5}],"금":[{"start":"05:30","end":"20:00","hours":14.5}],"토":[{"start":"05:30","end":"16:00","hours":10.5}],"일":[{"start":"09:00","end":"16:00","hours":7,"weeks":[1,2,4,5]}]}$$::jsonb, $${"일":"매월 셋째 주 일요일은 휴장합니다."}$$::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0157', '완주국민체육센터', '전북', '완주군', '전북특별자치도 완주군 용진읍 완주로 860',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0157', '풀스데이', $${"화":[{"start":"06:00","end":"21:00","hours":15}],"수":[{"start":"06:00","end":"21:00","hours":15}],"목":[{"start":"06:00","end":"21:00","hours":15}],"금":[{"start":"06:00","end":"21:00","hours":15}],"토":[{"start":"06:00","end":"21:00","hours":15}],"일":[{"start":"06:00","end":"21:00","hours":15}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0158', '순천팔마수영장', '전남', '순천시', '전라남도 순천시 팔마로 333',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0158', '풀스데이', $${"월":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"16:50","hours":3.83},{"start":"18:00","end":"20:50","hours":2.83}],"화":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"16:50","hours":3.83},{"start":"18:00","end":"20:50","hours":2.83}],"수":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"16:50","hours":3.83},{"start":"18:00","end":"20:50","hours":2.83}],"목":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"16:50","hours":3.83},{"start":"18:00","end":"20:50","hours":2.83}],"금":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"16:50","hours":3.83},{"start":"18:00","end":"20:50","hours":2.83}],"토":[{"start":"09:30","end":"11:50","hours":2.33},{"start":"13:00","end":"17:50","hours":4.83}],"일":[{"start":"09:30","end":"11:50","hours":2.33},{"start":"13:00","end":"17:50","hours":4.83}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0159', '순천문화건강센터수영장', '전남', '순천시', '전라남도 순천시 환선로 133',
...
insert into public.pools (
  ...
  ('POOL_0160', '순천신대유청소년수영장', '전남', '순천시', '전라남도 순천시 해룡면 매안로 138',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0160', '풀스데이', $${"월":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"15:50","hours":2.83},{"start":"19:00","end":"20:50","hours":1.83}],"화":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"15:50","hours":2.83},{"start":"19:00","end":"20:50","hours":1.83}],"수":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"15:50","hours":2.83},{"start":"19:00","end":"20:50","hours":1.83}],"목":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"15:50","hours":2.83},{"start":"19:00","end":"20:50","hours":1.83}],"금":[{"start":"05:30","end":"11:50","hours":6.33},{"start":"13:00","end":"15:50","hours":2.83},{"start":"19:00","end":"20:50","hours":1.83}],"토":[{"start":"09:00","end":"11:50","hours":2.83},{"start":"13:00","end":"17:50","hours":4.83}],"일":[{"start":"09:00","end":"11:50","hours":2.83},{"start":"13:00","end":"17:50","hours":4.83}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0161', '목포실내체육관실내수영장', '전남', '목포시', '전라남도 목포시 대양로 286',
...
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
  ('POOL_0161', '풀스데이', $${"토":[{"start":"05:30","end":"12:00","hours":6.5},{"start":"13:00","end":"18:00","hours":5}],"일":[{"start":"05:30","end":"12:00","hours":6.5},{"start":"13:00","end":"18:00","hours":5}]}$$::jsonb, '{}'::jsonb, '2026-06-10'::timestamptz)
on conflict (pool_id) do nothing;
...
insert into public.pools (
  ...
  ('POOL_0162', '나주국민체육센터생활체육관실내수영장', '전남', '나주시', '전라남도 나주시 영산강변로 99',
...
insert into public.pools (
  ...
  ('POOL_0163', '무안실내수영장', '전남', '무안군', '전라남도 무안군 현경면 공항로 345',
...
insert into public.pools (
  ...
  ('POOL_0164', '영광스포티움실내수영장', '전남', '영광군', '전라남도 영광군 영광읍 중앙로 203',
