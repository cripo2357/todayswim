...
insert into public.pools (id, name, region, district, address, lat, lng, type, ownership, phone, website, lane_count, pool_length, depth_min, depth_max, facilities, has_kids_pool, has_diving_pool, is_hotel_pool, has_schedule, free_swim_available, price_weekday, price_weekend, photo_url, schedule_source_url) values
  ('POOL_0535', '홍천군국민체육센터수영장', '강원', '홍천군', '강원특별자치도 홍천군 홍천읍 태학여내길 31', 37.7091202926911, 127.906304544853, 'indoor', 'public', '033-436-7330', 'http://sports.gangwon.kr', 6, 25, null, 1.5, '{}', true, false, false, true, true, 3000, 3000, null, 'http://sports.gangwon.kr')
...
insert into public.pools (id, name, region, district, address, lat, lng, type, ownership, phone, website, lane_count, pool_length, depth_min, depth_max, facilities, has_kids_pool, has_diving_pool, is_hotel_pool, has_schedule, free_swim_available, price_weekday, price_weekend, photo_url, schedule_source_url) values
  ('POOL_0536', '횡성실내수영장', '강원', '횡성군', '강원특별자치도 횡성군 횡성읍 문화체육로 57', 37.49609012048301, 127.98913953924048, 'indoor', 'public', '033-342-5663', 'https://www.hsg.go.kr', 7, 25, null, null, '{}', true, false, false, true, true, 3000, 3000, null, 'https://www.hsg.go.kr')
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
...
insert into public.pools (id, name, region, district, address, lat, lng, type, ownership, phone, website, lane_count, pool_length, depth_min, depth_max, facilities, has_kids_pool, has_diving_pool, is_hotel_pool, has_schedule, free_swim_available, price_weekday, price_weekend, photo_url, schedule_source_url) values
  ('POOL_0538', '정선군국민체육센터수영장', '강원', '정선군', '강원특별자치도 정선군 정선읍 녹송4길 51', 37.3842167430928, 128.672337563522, 'indoor', 'public', '033-560-3440', 'https://jsimc.or.kr', 6, 25, null, null, '{}', true, false, false, true, true, 2500, 2500, null, 'https://jsimc.or.kr')
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
...
insert into public.pools (id, name, region, district, address, lat, lng, type, ownership, phone, website, lane_count, pool_length, depth_min, depth_max, facilities, has_kids_pool, has_diving_pool, is_hotel_pool, has_schedule, free_swim_available, price_weekday, price_weekend, photo_url, schedule_source_url) values
  ('POOL_0540', '인제하늘내린스포츠센터수영장', '강원', '인제군', '강원특별자치도 인제군 인제읍 남북리 388', 38.06116814581964, 128.16486128785107, 'indoor', 'public', null, 'https://injesports.co.kr', null, null, null, null, '{}', false, false, false, true, true, 3000, 3000, null, 'https://injesports.co.kr')
on conflict (id) do nothing;
insert into public.schedules (pool_id, author_nickname, by_day, day_notes, updated_at) values
