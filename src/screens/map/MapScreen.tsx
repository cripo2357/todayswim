...
const MARKER_LOCATION      = require('@assets/markers/marker-location.png'); // 로그아웃 내 위치 핀
 ...
 *  로그아웃은 marker-location.png(핀)을 image로 직접 사용. */
    ...
    <View style={styles.root}>
      ...
      >
        {/* 내 위치 마커 — 로그인이면 노란 원+프로필 사진(커스텀 children,
            Figma 130:3622), 로그아웃이면 기존 핀 marker-location.png. */}
