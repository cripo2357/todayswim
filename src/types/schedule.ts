...
export interface TimeSlot {
  ...
  hours?: number;
  /**
   * 운영 주차 제약 (1~5). 없거나 빈 배열이면 매주 운영(기존 데이터 하위호환).
   * 예: [1,3] = 그 요일의 1·3주차에만 운영. 보통 일요일 주차 운영에 사용.
   * 주차 기준은 매월 1일·월요일 시작([[weekOfMonth]]) — 1주차가 부분주라 특정 요일이 1주차에 없을 수 있음.
   * 등록 시트: 선택 날짜의 주차에 안 맞는 슬롯은 숨김. 시간표 보기: "1·3주" 뱃지.
   */
  weeks?: number[];
}
